  ...
  return (
    <div
      ...
      className={cn(
        ...
        interactive &&
          'transition-[border-color,box-shadow,transform] duration-[var(--duration-base)] ease-[var(--ease-out-expo)] hover:-translate-y-1 hover:border-border-strong hover:shadow-[0_18px_44px_-18px_rgba(14,116,144,0.32)]',
        className,
      )}
      {...props}
    />
